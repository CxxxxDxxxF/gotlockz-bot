...
class MLBIntegratedService:
    ...
    def _transform_game_data(self, game_data: Dict[str, Any], bet_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            transformed = {
                ...
                "weather": {
                    "data": {team1: team1_data.get("weather", {}), team2: team2_data.get("weather", {})},
                    "summary": self._generate_weather_summary(
                        team1_data.get("weather", {}), team2_data.get("weather", {})
                    ),
                    "available": bool(team1_data.get("weather") or team2_data.get("weather")),
                },
                "park_factors": self._get_park_factors(team1, team2),
                "statcast": {"available": False, "data": {}},  # Will be added later if needed
    ...
    def _calculate_recent_form(self, stats: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"form": form, "win_pct": win_pct, "games_analyzed": stats.get("games_played", 0)}
