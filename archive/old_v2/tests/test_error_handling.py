...
class TestErrorHandling:
    ...
    def test_weather_impact_calculation_with_nones(self, weather_service):
        ...
        result = weather_service._calculate_overall_impact(
            temp_impact=None, wind_impact=None, humidity_impact=None, pressure_impact=None, ballpark_impact=None
        )
        assert isinstance(result, dict)
        assert "factor" in result
        assert "category" in result
        ...
        result = weather_service._calculate_overall_impact(
            temp_impact=temp_impact, wind_impact=None, humidity_impact=None, pressure_impact=None, ballpark_impact=None
        )
        assert isinstance(result, dict)
