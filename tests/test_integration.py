        ...
        if success:
            ...
            if game_data:
                ...
                if team1_data:
                    ...
                    print(f"Team 1 stats: {basic_stats.get('wins', 0)}-{basic_stats.get('losses', 0)} ({basic_stats.get('win_pct', 0):.3f})")
                
                if team2_data:
                    basic_stats = team2_data.get('basic_stats', {})
                    print(f"Team 2 stats: {basic_stats.get('wins', 0)}-{basic_stats.get('losses', 0)} ({basic_stats.get('win_pct', 0):.3f})")
...
async def test_pick_command_integration():
    ...
    try:
        ...
        if stats_data:
            ...
            print(f"Data structure matches expected format: {bool(stats_data.get('team1') and stats_data.get('team2'))}")
